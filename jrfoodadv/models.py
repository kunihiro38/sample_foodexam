...
class Record(models.Model):
    """問題の解答記録
    """
    # 基はJrFoodLabelingAdviseQuestionのquestion_idで1対1
...
class TextbookChapter():
    ...
    def textbook_chapter_as_str(cls, textbook_chapter:int) -> str:
        ...
        elif textbook_chapter == TextbookChapter.LABELING_BRIDGE:
        ...
        elif textbook_chapter == TextbookChapter.VARIOUS_FOOD:
            return cls.TEXTBOOK_CHAPTER_CHOICES[3][1]
        elif textbook_chapter == TextbookChapter.OTHER_FOOD:
            return cls.TEXTBOOK_CHAPTER_CHOICES[4][1]
        elif textbook_chapter == TextbookChapter.THINK_FOOD:
            return cls.TEXTBOOK_CHAPTER_CHOICES[5][1]
        else:
            raise RuntimeError('invalid')


class JrFoodLabelingAdviseQuestion(models.Model):
    """問題
    """
    class Meta:
    ...
    @classmethod
    def count_jrfoodadv_questions(cls):
        """ 問題総数をカウントして返す
            return: int
        """
