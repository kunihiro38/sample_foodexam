"""
test_forms.pyの全体テスト
% python manage.py test jrfoodadv.tests.test_forms

test_forms.pyのユニットテスト
% python manage.py test jrfoodadv.tests.test_forms.SelectQuestionFormTests.test_correct_form
"""

from django.test import TestCase

from jrfoodadv.forms import SelectQuestionForm, SelectPracticeTestForm
