...
function SendTargetChoicesToServer(unquestioned=false, miss=false) {
    ...
    .done(function(data){
        ...
        // カウント数を付与
        $('label #id_chapter_0').parent().append('<span style="color:#697679;" id="textbook_chapter_1">'+' '+data['LAW_SYSTEM']+'</span>');
        ...
        $('label #id_chapter_3').parent().append('<span style="color:#697679;" id="textbook_chapter_4">'+' '+data['LABEL_EXAMPLE']+'</span>');
        $('label #id_chapter_4').parent().append('<span style="color:#697679;" id="textbook_chapter_5">'+' '+data['INDIVIDUAL_COMMENTARY']+'</span>');
        $('label #id_chapter_5').parent().append('<span style="color:#697679;" id="textbook_chapter_6">'+' '+data['NUTRITION_LABEL']+'</span>');
